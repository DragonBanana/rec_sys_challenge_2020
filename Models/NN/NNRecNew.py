...
class NNRecNew(RecommenderBase):
    ...
    def fit(self,
        ...
        for epoch_i in range(0, self.epochs):
            ...
            print('Training...')
            avg_train_loss, training_time = self.train(self.model, train_dataset, optimizer, scheduler)
    ...
    def train(self, model, train_dataset, optimizer, scheduler):
        ...
        for step, batch in tqdm(enumerate(train_dataset), total=len(train_dataset)):
            ...
            if step % 40 == 0 and not step == 0:
                ...
                # Report progress.
                print('  Batch {:>5,}  of  {:>5,}.    Elapsed: {:}.'.format(step, len(train_dataset), elapsed))
    ...
    def validation(self, model, val_dataset):
