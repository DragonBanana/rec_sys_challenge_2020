...
import sys
sys.path.append("../../LibraryNew/Data")
...
class XGBoost(RecommenderBase):
    ...
    def __init__(self, 
                 ...
                 param = {'objective': 'binary:logistic', #outputs the binary classification probability
                          ...
                          'min_child_weight' : 1,  #(1, 10), #Minimum sum of instance weight (hessian) needed in a child.
                          'scale_pos_weight' : 1.2, #(1, 1.5),
                          #'n_estimators': 250, #(300, 800), present in 2019 cannot find in doc| GIVES WARNING
                          'subsample': 0.8 #(0.6, 1),
