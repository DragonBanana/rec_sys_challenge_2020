...
class TweetFeatureTextEmbeddingsPCA32(TweetFeatureTextEmbeddings):
    ...
    def load_embeddings_dictionary(self):
        tweet_text_embeddings_dict_array = TweetTextEmbeddingsPCA32FeatureDictArray()
        self.embeddings_array = tweet_text_embeddings_dict_array.load_or_create()
...
class TweetFeatureTextEmbeddingsPCA10(TweetFeatureTextEmbeddings):
    ...
    def load_embeddings_dictionary(self):
        tweet_text_embeddings_dict_array = TweetTextEmbeddingsPCA10FeatureDictArray()
        self.embeddings_array = tweet_text_embeddings_dict_array.load_or_create()
...
class TweetFeatureTextEmbeddingsHashtagsMentionsLDA15(TweetFeatureTextEmbeddings):
    ...
    def load_embeddings_dictionary(self):
        tweet_text_embeddings_dict_array = TweetTextEmbeddingsHashtagsMentionsLDA15FeatureDictArray()
        self.embeddings_array = tweet_text_embeddings_dict_array.load_or_create()
