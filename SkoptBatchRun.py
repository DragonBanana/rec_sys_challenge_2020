...
def main():
    ...
    X_label = [
        ...
        "tweet_feature_is_retweetskoptTestRUN.py",
    ...
    OP.setParameters(n_calls=20, n_random_starts=5)
    OP.batchTrain(tot_train_split=10, train_id="train_days_1")
    OP.batchVal(tot_val_split=10, val_id="val_days_2")
