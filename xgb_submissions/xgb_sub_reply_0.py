...
submission_filename = f"xgb_submission_{label}_0.csv"
...
xgb_parameters = {
    'max_depth': 13,
    'min_child_weight': 88,
    'colsample_bytree': 0.4499723255619491,
    'learning_rate': 0.05936449833058634,
    'reg_alpha': 1.0,
    'reg_lambda': 1.0,
    'scale_pos_weight': 1,
    'gamma': 0.9960657403330612,
    'subsample': 0.5161657588808174,
    'base_score': 0.0274,
    'max_delta_step': 0.0,
