...
def main():  
    ...
    X_label = [
            ...
            #"is_tweet_in_creator_main_language",                        #46 CATEGORICAL                -32
            #"is_tweet_in_engager_main_language",                        #47 CATEGORICAL                33
            #"statistical_probability_main_language_of_engager_engage_tweet_language_1",                     #48     34                                               
            #"statistical_probability_main_language_of_engager_engage_tweet_language_2",                     #49     35                                              
    ...
    OP = Optimizer(model_name, 
                   ...
                   mode=0,
                   path="like",
                   path_log="LGBM-reply-opt-latest",
                   make_log=True, 
                   make_save=False, 
                   auto_save=False)
